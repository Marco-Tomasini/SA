-- ==========================================================
-- SCRIPT DE POPULAÇÃO (SOMENTE DADOS)
-- ==========================================================

-- 1. Configurações para aceitar acentos e evitar erros de chave
SET NAMES 'utf8mb4';
SET FOREIGN_KEY_CHECKS = 0;

-- 2. Seleção do Banco (Verifique se o nome está correto para o seu caso)
USE SmartCitiesV11;
